...
Honest strongest claim: `Select new robot data by uncovered failure mechanisms, not by task labels.` is a plausible branch-structured mechanism for robot data engines, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
