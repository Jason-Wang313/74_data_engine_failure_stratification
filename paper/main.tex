...
\usepackage{url}
\usepackage{booktabs}
\title{Data Engine Failure Stratification: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about robot data engines. The original research bet was: Select new robot data by uncovered failure mechanisms, not by task labels. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item Big Data and Telemetry Data Methodology for Usage Failure Mode Detection (2024)
\item Scaling Cross-Environment Failure Reasoning Data for Vision-Language Robotic Manipulation (2025)
\item A new data envelopment analysis-based model for failure mode and effect analysis with heterogeneous information (2021)
\item Correction to: 2016 ACC/AHA/HFSA Focused Update on New Pharmacological Therapy for Heart Failure: An Update of the 2013 ACCF/AHA Guideline for the Management of Heart Failure: A Report of the American College of Cardiology Foundation/American Heart Association Task Force on Clinical Practice Guidelines and the Heart Failure Society of America (2016)
\item Method for correlation of failure data from durability tests and field of automotive engine parts with spontaneous failure mode (2026)
\end{itemize}
