...
This repository contains a hardened, honest workshop-only robotics paper draft for `data_engine_failure_stratification`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/74.pdf`
